...
public class MapSchemaProcessor extends SchemaProcessor {

    private static final Logger logger = LoggerFactory.getLogger(MapSchemaProcessor.class);

    public MapSchemaProcessor(SchemaHandler handler) {
        super(handler);
    }
